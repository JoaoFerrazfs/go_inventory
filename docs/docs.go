...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/products": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Product Data (EAN must be 13 digits)",
                        "name": "product",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/apiContracts.ProductResponse"
                        }
                    },
                    "422": {
                        "description": "Unprocessable Entity",
        ...
        "/api/v1/products/{ean}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Product EAN (13 digits)",
                        "name": "ean",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "apiContracts.ProductResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/apiContracts.ProductData"
                }
            }
        },
