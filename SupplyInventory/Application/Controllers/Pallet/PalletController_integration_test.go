...
func (m *mockPalletRepository) UpdatePallet(id uint, name string, rackId uint) (*entities.PalletEntity, *errors.AppError) {
...
func (m *mockPalletRepository) Create(pallet *entities.PalletEntity) error {
	args := m.Called(pallet)
	return args.Error(0)
}
func (m *mockPalletRepository) FindByID(id uint) (*entities.PalletEntity, error) {
	args := m.Called(id)
	if args.Get(0) == nil {
...
func (m *mockPalletRepository) List() ([]*entities.PalletEntity, error) {
	args := m.Called()
	return args.Get(0).([]*entities.PalletEntity), args.Error(1)
}
...
func (m *mockPalletRepository) Update(pallet *entities.PalletEntity) error {
	args := m.Called(pallet)
	return args.Error(0)
}
...
func (m *mockPalletRepository) GetAllPallets() ([]entities.PalletEntity, *errors.AppError) {
	args := m.Called()
	return args.Get(0).([]entities.PalletEntity), args.Get(1).(*errors.AppError)
}
func (m *mockPalletRepository) GetSupplyById(id uint) (*entities.PalletEntity, *errors.AppError) {
	args := m.Called(id)
	if args.Get(0) == nil {
		return nil, args.Get(1).(*errors.AppError)
	}
...
func (m *mockPalletRepository) AddSupply(name string, rackId uint) (*entities.PalletEntity, *errors.AppError) {
...
func (m *mockPalletRepository) UpdateSupply(pallet *entities.PalletEntity) (*entities.PalletEntity, *errors.AppError) {
	args := m.Called(pallet)
	if args.Get(0) == nil {
		return nil, args.Get(1).(*errors.AppError)
	}
...
func TestIntegration_CreatePallet(t *testing.T) {
	...
	// Expectations
	mockRepo.On("Create", mock.AnythingOfType("*entities.PalletEntity")).Return(nil)
	mockRepo.On("AddSupply", "Pallet1", uint(1)).Return(&entities.PalletEntity{ID: 1, Name: "Pallet1"}, (*errors.AppError)(nil))
	mockQR.On("CreateQRCode", mock.AnythingOfType("uint")).Return("/tmp/fake.png", nil)
	mockRepo.On("UpdateSupply", mock.AnythingOfType("*entities.PalletEntity")).Return(&entities.PalletEntity{ID: 1, Name: "Pallet1", QrCode: "/tmp/fake.png", QrCodeUrl: "http://localhost:3000//tmp/fake.png"}, (*errors.AppError)(nil))
